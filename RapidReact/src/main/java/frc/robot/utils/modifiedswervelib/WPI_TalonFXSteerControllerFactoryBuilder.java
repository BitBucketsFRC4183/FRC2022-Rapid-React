...
public final class WPI_TalonFXSteerControllerFactoryBuilder {
  ...
  public WPI_TalonFXSteerControllerFactoryBuilder withPidConstants(
    double proportional,
    double integral,
    double derivative
  ) {
  ...
  public boolean hasPidConstants() {
    return (
      Double.isFinite(proportionalConstant) && Double.isFinite(integralConstant) && Double.isFinite(derivativeConstant)
    );
  }

  public WPI_TalonFXSteerControllerFactoryBuilder withMotionMagic(
  ...
  public boolean hasMotionMagic() {
    return (
      Double.isFinite(velocityConstant) && Double.isFinite(accelerationConstant) && Double.isFinite(staticConstant)
    );
  }
  ...
  public <T> SteerControllerFactory<ControllerImplementation, WPI_TalonFXSteerConfiguration<T>> build(
  ...
  private class FactoryImplementation<T>
    implements SteerControllerFactory<ControllerImplementation, WPI_TalonFXSteerConfiguration<T>> {
    ...
    public ControllerImplementation create(
      WPI_TalonFXSteerConfiguration<T> steerConfiguration,
