...
public final class WPI_TalonFXSteerControllerFactoryBuilder {
    ...
    public WPI_TalonFXSteerControllerFactoryBuilder withPidConstants(double proportional, double integral, double derivative) {
    ...
    public WPI_TalonFXSteerControllerFactoryBuilder withMotionMagic(double velocityConstant, double accelerationConstant, double staticConstant) {
    ...
    public WPI_TalonFXSteerControllerFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public WPI_TalonFXSteerControllerFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    public <T> SteerControllerFactory<ControllerImplementation, WPI_TalonFXSteerConfiguration<T>> build(AbsoluteEncoderFactory<T> absoluteEncoderFactory) {
        return new FactoryImplementation<>(absoluteEncoderFactory);
    }

    private class FactoryImplementation<T> implements SteerControllerFactory<ControllerImplementation, WPI_TalonFXSteerConfiguration<T>> {
        ...
        @Override
        public ControllerImplementation create(WPI_TalonFXSteerConfiguration<T> steerConfiguration, ModuleConfiguration moduleConfiguration) {
