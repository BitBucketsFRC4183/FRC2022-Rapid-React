...
public final class Constants {
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.3937; // FIXME Measure and set trackwidth
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.3937; // FIXME Measure and set wheelbase
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(345); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(149); // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(321); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(60.9); // FIXME Measure and set back right steer offset
}
