...
public class DriveSubsystem2 extends SubsystemBase implements RunCycle {
    ...
    public void command(int[] speeds) {
        command(new ChassisSpeeds(speeds[0], speeds[1], speeds[2]));
    }
