...
public class Config {
  ...
  public Config() {
    ...
    shooter.shooterTop.velocityPIDF = new PIDF(/*P*/0.0001, /*I*/0.001 / 1000, /*D*/0, /*F*/(7.0 / 12.0) / (60 * 60), /*izone*/300);
    shooter.shooterTop.inverted = true;

    shooter.shooterBottom.id = shooterBottom_ID;
    shooter.shooterBottom.velocityPIDF = new PIDF(/*P*/0.0001, /*I*/0.001 / 1000, /*D*/0, /*F*/(7.0 / 12.0) / (60 * 60), /*izone*/300);
